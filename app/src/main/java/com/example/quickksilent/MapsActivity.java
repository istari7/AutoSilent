        ...
        try{
            ...
            mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                ...
                public void onMapClick(final LatLng arg0) {
                    ...
                    Toast.makeText(getApplicationContext(),getAddress(lati,loni),Toast.LENGTH_SHORT).show();
                    bt.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            gps.put("id", "email");
                            gps.put("latitude", arg0.latitude);
                            gps.put("longitude",arg0.longitude);
                            gps.put("name",getAddress(lati,loni));
                            ...
                            db.collection("locations")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                        ...
                                        public void onSuccess(DocumentReference documentReference) {
                                            Toast.makeText(getApplicationContext(),"Geofences Added Succesfully",Toast.LENGTH_SHORT).show();
                                            removeGeofences();
                                            populateGeofenceList();
                                            addGeofences();
                                            Intent it = new Intent(MapsActivity.this,MapList.class);
                                            startActivity(it);
...
//Here modification took place
    ...
    private void populateGeofenceList() {
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                mGeofenceList.add(new Geofence.Builder()
                                        ...
                                        // geofence.
                                        .setRequestId(document.get("name").toString())
                                        ...
                                        // Create the geofence.
                                        .build());
                                //   String x = document.get("name").toString();
                                //  name.add(x);

                            }
                            //   adapter = new ArrayAdapter<String>(MapsActivity.this,android.R.layout.simple_list_item_1,name);
        ...
        for (HashMap.Entry<String,LatLng> entry : Constants.GEOFENCE_PONTS.entrySet()) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Get the geofences used. Geofence data is taken from firebase right here(quicksilent).
        populateGeofenceList();
