...
public class EditTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle editTimeState) {
        ...
        startTime = (TimePicker) findViewById(R.id.tpeStart);
        endTime = (TimePicker) findViewById(R.id.tpeEnd);
        sun = (CheckBox) findViewById(R.id.cbeSun);
        mon = (CheckBox) findViewById(R.id.cbeMon);
        tue = (CheckBox) findViewById(R.id.cbeTue);
        wed = (CheckBox) findViewById(R.id.cbeWed);
        thu = (CheckBox) findViewById(R.id.cbeThu);
        fri = (CheckBox) findViewById(R.id.cbeFri);
        sat = (CheckBox) findViewById(R.id.cbeSat);
        update = (Button) findViewById(R.id.beupdate);
        delete = (Button) findViewById(R.id.beDelete);
        cancel = (Button) findViewById(R.id.beCancel);
                    ...
                    if(sqlstart != sqlend){
                        ...
                        if(!sqlname.equals(Name)){
                            if(!checkName.contains(sqlname)){
                                ...
                                Intent openCreate = new Intent(EditTime.this,TimeView.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent openTimeView = new Intent(EditTime.this,TimeView.class);
